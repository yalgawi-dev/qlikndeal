...
export const BaseCategoryRegistry: Record<string, CategoryRegistryEntry> = {
  LAPTOPS: {
    ...
    nlpKeywords: ["laptop", "laptops", "מחשב נייד", "נייד", "macbook", "thinkpad"],
    regex: /מחשב נייד|לפטופ|נייד|macbook/i,
  ...
  SMARTPHONES: {
    ...
    nlpKeywords: ["mobile", "phone", "smartphone", "טלפון", "סלולר", "סמארטפון", "iphone", "galaxy"],
    regex: /טלפון|סלולרי|אייפון|גלקסי|iphone|galaxy|smartphone/i,
  ...
  ELECTRONICS: {
    ...
    regex: /מסך|אוזניות|טלוויזיה|שעון/i,
  ...
  AIO: {
    ...
    nlpKeywords: ["aio", "all in one", "all in 1"],
    regex: /aio|אול אין וואן/i,
  ...
  CUSTOM_COMPUTERS: {
    ...
    regex: /הרכבה|custom pc/i,
    learnFields: ["category", "subCategory", "typicalCpu", "typicalGpu"],
